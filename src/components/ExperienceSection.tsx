  ...
  const experiences = [
    {
      ...
      achievements: [
        ...
        "Deployed applications to Firebase, Heroku, Netlify, AWS EC2, AWS Amplify, and Render using CI/CD pipelines powered by GitHub Actions",
        "Conducted detailed code reviews and performance optimizations.",
        "Built applications with low-code tools like Bubble.io and automated workflows with n8n",
        "Engineered secure APIs and database schemas using NestJS."
      ],
    },
    {
      ...
      achievements: [
        ...
        "Implemented testing",
        "Implemented secure auth flows with JWT and Express.",
      ],
    },
    {
      ...
      technologies: ["JavaScript", "React", "CSS3", "HTML5", "Figma", "Redux"],
      achievements: ["Developed and maintained responsive, user-centric web and mobile interfaces using React Native, Next.js, and AngularJS.",
        "Delivered 5+ Projects",
        "Built reusable UI components and managed application state with Redux Thunk.",
        "Collaborated with international clients to deliver high-quality, pixel-perfect designs across projects.",
        "Optimized front-end performance and accessibility, ensuring cross-browser compatibility and mobile responsiveness.",
      ],
    },
  ];
